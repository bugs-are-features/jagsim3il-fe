...
export function ChallengeDetailModal({ visible, onClose, challenge, canLeave, onLeave }) {
    ...
    <BottomSheet visible={visible} onClose={onClose}>
        ...
        >
          ...
          <View className="mb-2 flex-row items-center justify-between">
            <Text className="text-sm font-gowunDodum text-ink-faint">참여 멤버 {challenge.memberCount}명</Text>
